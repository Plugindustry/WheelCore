...
public enum Mineral {
    COPPER("copper", "Cu", 0.9), IRON("iron", "Fe", 0.8), CALCIUM("calcium", "Ca", 0.83), POTASSIUM("potassium", "K", 0.85), SLIVER("sliver", "Ag", 0.95), TIN("tin", "Sn", 0.78), LEAD("lead", "Pb", 0.75), SODIUM("sodium", "Na", 0.8), ALUMINIUM("aluminium", "Al", 0.85), GOLD("gold", "Au", 0.87);
