...
public class RegisterTask {
    ...
    public static void registerVanillaOreDict() {
        ...
        for (Material type : Material.values()) {
            ...
            if (type.isRecord()) dict.add("record");
            if (type.hasGravity()) dict.add("gravity");
            if (type.isFuel()) dict.add("fuel");
            if (type.getMaxDurability() > 0) dict.add("tool");
            if (type.isBlock()) dict.add("block");

            String name = type.name();
            if (name.endsWith("_HELMET")) dict.add("helmet");
            if (name.endsWith("_CHESTPLATE")) dict.add("chestplate");
            if (name.endsWith("_LEGGINGS")) dict.add("leggings");
            if (name.endsWith("_BOOTS")) dict.add("boots");
            if (name.endsWith("_SWORD")) dict.add("sword");
            if (name.endsWith("_AXE")) dict.add("axe");
            if (name.endsWith("_PICKAXE")) dict.add("pickaxe");
            if (name.endsWith("_SHOVEL")) dict.add("shovel");
            if (name.endsWith("_HOE")) dict.add("hoe");
            if (name.endsWith("_HORSE_ARMOR")) dict.add("horse_armor");
            if (name.equals("BOW")) dict.add("bow");
            if (name.equals("FISHING_ROD")) dict.add("fishing_rod");
            if (name.equals("SHIELD")) dict.add("shield");
            if (name.equals("ELYTRA")) dict.add("elytra");
            if (name.equals("TRIDENT")) dict.add("trident");
            if (name.equals("SHULKER_SHELL")) dict.add("shulker_shell");
            if (name.equals("TOTEM_OF_UNDYING")) dict.add("totem_of_undying");
            if (name.endsWith("_SHULKER_BOX")) dict.add("shulker_box");
            if (name.endsWith("_BANNER")) dict.add("banner");
